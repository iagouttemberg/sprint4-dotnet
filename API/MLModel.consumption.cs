...
namespace API
{
    public partial class MLModel
    {
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Avaliacao");
            if (labelColumn == null)
            {
                throw new Exception("Avaliacao column not found. Make sure the name searched for matches the name in the schema.");
            }
