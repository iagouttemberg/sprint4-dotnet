...
namespace API
{
    ...
    {
        public const string RetrainFilePath =  @"C:\Users\iagoc\Downloads\comentarios_assistente_virtual(1).txt";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"Avaliacao",inputColumnName:@"Avaliacao",addKeyValueAnnotationsAsText:false)      
                                    .Append(mlContext.MulticlassClassification.Trainers.TextClassification(labelColumnName: @"Avaliacao", sentence1ColumnName: @"Comentario"))      
